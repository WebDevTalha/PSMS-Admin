...
if(isset($_POST['submit_btn'])){
    ...
    if(empty($class_id)){
        ...
        $stm=$pdo->prepare("SELECT final_exam.id,final_exam.class_id,final_exam.teacher_id,final_exam.subject_id,final_exam.exam_id,teachers.name as teacher_name,subjects.name as subject_name,subjects.code as subject_code FROM final_exam  
        INNER JOIN teachers ON final_exam.teacher_id = teachers.id 
...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body"> 
            ...
            <br><br>
            <a href="student_mark_details.php?class=<?php echo $_POST['select_class'];?>" class="btn btn-info">Get Marks Calculation</a>
            <?php endif;?>
        </div>
    </div>
</div> 
